...
const SafeArea = ({
  ...
  const dialogues = [
    ...
    "For all your hard work, I have a gift for you! Here are some Bitblops to help you on your journey!",
    "There are more things to be done, refresh the page and continue your journey!",
  ];
  ...
  const handleInteraction = () => {
    ...
    if (talkCounter === 2) {
      setBitblops((prevBitblops) => prevBitblops + 15);
    }
  };
