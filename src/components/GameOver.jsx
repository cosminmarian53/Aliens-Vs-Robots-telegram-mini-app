...
const GameOver = ({ resetPlayerHealth }) => {
  return (
    <div className="game-over flex flex-col items-center justify-center min-h-screen p-4">
      <h1 className="game-over-header text-4xl md:text-6xl font-bold mb-4 text-center">
        Game Over
      </h1>
      ...
      <button
        ...
        onClick={() => {
          resetPlayerHealth(); // Reset player health for the new stage
